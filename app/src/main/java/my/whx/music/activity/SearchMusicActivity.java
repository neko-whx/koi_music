...
import my.whx.music.adapter.SearchMusicAdapter;
import my.whx.music.enums.LoadStateEnum;
import my.whx.music.executor.DownloadSearchedMusic;
import my.whx.music.executor.PlaySearchedMusic;
...
public class SearchMusicActivity extends BaseActivity implements SearchView.OnQueryTextListener
    ...
    private final List<SearchMusic.Song> searchMusicList = new ArrayList<>();
    private final SearchMusicAdapter mAdapter = new SearchMusicAdapter(searchMusicList);
